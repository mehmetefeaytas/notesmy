# 🇫🇷 NotesMy — Second Cerveau & Pense-bêtes propulsés par l'IA pour macOS
...
<p align="center">
  <strong>Notes adhésives sans friction sur le bord de l'écran, graphe de connaissances, transcription vocale & IA hors ligne</strong>
</p>
...
## 🤝 Contribution & Politique de Publication

Les contributions et rapports de bugs sont les bienvenus ! La publication de versions officielles est strictement réservée au mainteneur ([@mehmetefeaytas](https://github.com/mehmetefeaytas)). Consultez [CONTRIBUTING.md](../CONTRIBUTING.md).
