...
<p align="center">
  <strong>Reibungslose Haftnotizen am Bildschirmrand, Wissensgraph, mehrsprachige Sprachmemos & 100% On-Device-KI</strong>
</p>
...
## 🤝 Mitwirken & Veröffentlichungsrichtlinie

Beiträge, Fehlerberichte und Funktionsvorschläge sind willkommen! Das Veröffentlichen neuer Releases ist ausschließlich dem Maintainer ([@mehmetefeaytas](https://github.com/mehmetefeaytas)) vorbehalten. Bitte beachten Sie die Richtlinien in [CONTRIBUTING.md](../CONTRIBUTING.md).
